...
<header>
  ...
  <section class="profileHeader"> 
    ...
    <?php include 'handler.php'; ?>
    <h1>Title :  <input type="text" name="title" id="title" value =<?php echo $row[0] ?>></h1>
    <hr>
    <label>Description</label>
    <br>
    <textarea name="description" id="description" form="part1" ><?php echo $row[1] ?></textarea>
  </section>
...
<section class="mainContent"> 
  ...
  <section class="section1">
    ...
    <?php include 'handler.php'; ?>
      <p><span>Email :</span><input type="text" name="email" id="email" value=<?php echo $row[2] ?> > </p>
      <p><span>Start Date : </span><input type="text" name="start_date" id="start_date" value=<?php echo $row[3] ?>></p>
      <p><span>End Date: </span> <input type="text" name="end_date" id="end_date" value=<?php echo $row[4] ?>></p>
      <p><span>funds needed: </span> <input type="text" name="funding_needed" id="funding" value=<?php echo $row[5] ?> ></p>
    </div>
  <aside class="externalResourcesNav">
    <div class="externalResources"><input type="submit" name="submit" value="update" /> </div>
      </form>
  </aside>
  </section>
</section>
