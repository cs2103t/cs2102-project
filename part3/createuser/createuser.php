...
<header>
  ...
  <section class="profileHeader"> 
    ...
    <?php include 'handler.php'; ?>
    <h1>Title :  <input type="text" name="title" id="title" ></h1>
    <hr>
...
<section class="mainContent"> 
  ...
  <section class="section1">
    ...
    <?php include 'handler.php'; ?>
      ...
      <p><span>Start Date : </span><input type="text" name="start_date" id="start_date" ></p>
      <p><span>End Date: </span> <input type="text" name="end_date" id="end_date" ></p>
      <p><span>funds needed: </span> <input type="text" name="funding_needed" id="funding" ></p>
    </div>
